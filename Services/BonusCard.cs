...
namespace Services
{
    public class BonusCard:IBaseObj
    {
        ...
        public int checkBonusCard(int partnerid)
        {
            string searchParams = "&PartnerId=" + partnerid;
        ...
        {
            const string chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789"; // You can customize the characters as needed
