...
namespace Services
{
    public class TableSaleDetails : IBaseObj
    {
        ...
        public static List<TableSaleDetails> GetTS()
        {
            var item = Services.RestHepler<TableSaleDetails>.Search("TablesSaleDetails", "");

            return item;
        }
        public int Insert()
        {
            int rows = Services.RestHepler<TableSaleDetails>.Insert("TablesSaleDetails", this);

            return rows;
        }
        public int Update()
        {
            int rows = Services.RestHepler<TableSaleDetails>.Update("TablesSaleDetails", this);
